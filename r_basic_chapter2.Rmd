...
For more advice, we highly recommend studying Hadley Wickham’s style guide 15.
...
Remake the data frame using the code above, but add a line thatom Fahrenheit to Celsius. The conversion is C=5/9*(F-32)
```{r}
c<-5/9*(temp-32)
